...
export const INTERNAL_LINKS: InternalLink[] = [
  // Fund Pages - Highest Priority
  {
    ...
    description: 'Tactical ETF that rotates between indices and cash',
    keywords: ['thir', 'index rotation', 'tactical etf', 'rotation strategy', 'go to cash'],
  ...
  },
  {
    ...
    description: 'Low volatility ETF with tactical cash capability',
  ...
  },
  {
    ...
    keywords: ['index rotation', 'rotation strategy', 'tactical rotation'],
  ...
  },
  {
    ...
    title: 'Tactical ETF Strategy',
    description: 'Tactical ETF investment approach',
    keywords: ['tactical etf', 'tactical strategy', 'active etf'],
    anchorVariants: ['tactical ETF', 'tactical strategy', 'tactical approach'],
    priority: 7,
    category: 'landing',
  },
  {
  ...
  },
  {
    ...
    keywords: ['index rotation strategy', 'rotation', 'tactical'],
    anchorVariants: ['index rotation strategy', 'rotation strategy', 'tactical rotation'],
    priority: 7,
    category: 'landing',
  },
  {
  ...
  // Book
  {
    url: '/book/',
    title: 'The Book',
    description: 'THOR Funds book on tactical investing',
    keywords: ['book', 'tactical investing book'],
    anchorVariants: ['the book', 'our book', 'tactical investing book'],
    priority: 6,
    category: 'resource',
  },
];
