          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 items-start">
              <div className="md:col-span-1">
                <div className="bg-navy-100 rounded-2xl aspect-square flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-32 h-32 bg-navy-800 rounded-full mx-auto flex items-center justify-center">
                      <span className="text-4xl font-bold text-gold-500">BR</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6 prose prose-navy max-w-none">
                  ...
                  <p className="text-gray-600 leading-relaxed mt-4">
                    Under Brad&apos;s leadership, THOR has grown to manage over $1.1 billion in assets and serves financial advisors across the country. He hosts the &quot;Behind the Ticker&quot; podcast, where he interviews leaders in the ETF and wealth management industry.
                  </p>
                </div>
