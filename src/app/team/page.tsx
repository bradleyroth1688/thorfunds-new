            ...
            <div className="grid md:grid-cols-3 gap-8 items-start">
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-6 prose prose-navy max-w-none">
                  ...
                  <p className="text-gray-600 leading-relaxed mt-4">
                    Under Brad&apos;s leadership, THOR has launched six distinct model portfolios and three actively managed ETFs, serving financial advisors across the country. He hosts the &quot;Behind the Ticker&quot; podcast, where he interviews leaders in the ETF and wealth management industry.
                  </p>
                </div>
