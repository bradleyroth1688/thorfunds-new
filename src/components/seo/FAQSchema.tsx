...
export const THIR_FAQS: FAQItem[] = [
  {
    ...
    answer: "THIR (THOR Index Rotation ETF) is an adaptive equity ETF that rotates between major market indices (S&P 500, Nasdaq 100, Russell 2000) and cash based on proprietary trend-following signals. When markets are trending up, THIR participates. When trends break down, THIR can move to cash to protect against significant drawdowns.",
  },
  {
    question: "What is the expense ratio for THIR?",
    answer: "THIR has a net expense ratio of 0.80%. This covers the active management, daily monitoring, and adaptive rotation strategy that aims to protect against major market downturns.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, THIR is designed for investors with a long-term perspective who want equity exposure but are concerned about major market drawdowns. It can serve as a core equity holding or as an adaptive sleeve within a diversified portfolio.",
  },
];
...
export const THLV_FAQS: FAQItem[] = [
  {
    ...
    answer: "THLV (THOR Low Volatility ETF) combines a low volatility stock selection process with the ability to reduce equity exposure during market stress. Unlike passive low vol ETFs, THLV can dynamically move to cash, providing an additional layer of downside protection.",
  },
  {
    question: "What is the expense ratio for THLV?",
    answer: "THLV has a net expense ratio of 0.49%, which is competitive with other actively managed low volatility ETFs while providing adaptive cash management capabilities.",
  },
  {
...
export const GENERAL_FAQS: FAQItem[] = [
  {
    ...
    answer: "THOR Funds specializes in risk-managed, adaptive ETFs that can adapt to changing market conditions. Our strategies combine systematic trend-following with the ability to move to cash, providing downside protection that traditional passive ETFs cannot offer.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, many financial advisors and RIAs use THOR ETFs as adaptive building blocks within client portfolios. We offer advisor resources, model portfolios, and institutional share classes. Contact advisors@thorfunds.com for more information.",
  },
  {
    question: "How much money does THOR Funds manage?",
    answer: "THOR Financial Technologies offers robust model offerings across two adaptive ETFs and separately managed accounts.",
  },
  {
    question: "Who is behind THOR Funds?",
    answer: "THOR Funds was founded by Brad Roth, who serves as Chief Investment Officer. Brad has over 15 years of experience in investment management and is a recognized thought leader in adaptive and risk-managed investing. The team includes experienced portfolio managers, analysts, and operations professionals.",
  },
];
